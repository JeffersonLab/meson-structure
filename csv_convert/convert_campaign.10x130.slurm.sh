...
#SBATCH --output=/volatile/eic/romanov/meson-structure-2025-08/convert_csv_10x130.%j.log
#SBATCH --error=/volatile/eic/romanov/meson-structure-2025-08/convert_csv_10x130.%j.err
