...
#SBATCH --job-name=MSCSV10x130
#SBATCH --time=1-00:00:00          # format days-hours:minutes:seconds
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=2G
#SBATCH --output=/volatile/eic/romanov/meson-structure-2025-10/convert_csv_10x130.%j.log
#SBATCH --error=/volatile/eic/romanov/meson-structure-2025-10/convert_csv_10x130.%j.err

set -euo pipefail

CAMPAIGN=/volatile/eic/romanov/meson-structure-2025-10/reco/10x130-priority
