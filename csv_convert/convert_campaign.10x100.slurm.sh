...
#SBATCH --output=/volatile/eic/romanov/meson-structure-2025-08/convert_csv_10x100.%j.log
#SBATCH --error=/volatile/eic/romanov/meson-structure-2025-08/convert_csv_10x100.%j.err
